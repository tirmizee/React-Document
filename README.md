...
- #### Statefull Component
  ...
  คือ component ที่มี state และจัดเก็บข้อมูลเกี่ยวกับการเปลี่ยนแปลง state ของ component ในหน่วยความจำ

- #### Stateless Component

  คือ component ที่ไม่มี state ใดๆเลย ซึ่งหมายความว่าไม่สามารถใช้ this.setState ภายใน component เหล่านี้ได้ เป็นฟังชันปกติไม้มี render method ไม่มี lifecycle
...
HOC คือ function ที่รับ component มาและ return conponent ใหม่ไป HOC ไม่ใช่ feature ใน React แต่เป็นรูปแบบของเทคนิคขั้นสูงในการ reuse component logic
