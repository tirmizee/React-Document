...
- #### Stateless Component
  ...
  คือ component ที่ไม่มี state ใดๆเลย ซึ่งหมายความว่ไม่สามารถใช้ this.setState ภายใน component เหล่านี้ เป็นฟังชันปกติไม้มี render method ไม่มี lifecycle
