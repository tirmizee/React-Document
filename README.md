...
Render method คือทำหน้าที่จัดการการเรนเดอร์ Component ของเราในขณะเข้าถึงหรือเปลี่ยนแปลง this.sate และ this.props ซึ่งเราจะไม่สามารถเรียกใช้ setState method ได้ใน render method
